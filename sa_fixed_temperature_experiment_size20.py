"""Fixed-temperature Metropolis (SA) experiment for size 20.

This is a size-20 variant of sa_fixed_temperature_experiment.py.
It sweeps over beta and number of Metropolis swaps at fixed
problem size N=20 for a few instances.
"""
...
# Scale steps range roughly proportional to problem size (20 vs 10)
STEPS_MIN = 200
STEPS_MAX = 6000
N_STEPS_VALUES = 10
...
OUTPUT_CSV = Path("sa_fixed_temp_traces_size20.csv")
